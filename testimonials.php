        ...
        <div class="row masonary-layout">
            ...
            <div class="col-xl-6 col-lg-6">
                <div class="single-testimonial-style2">
                    ...
                    <div class="text-box">
                        <p>Experience with Horizoncave has been very accommodating forthey
            ...
            <!--Start Single Testimonial Style2-->
            <div class="col-xl-6 col-lg-6">
                <div class="single-testimonial-style2 bg-white">
                    <div class="top">
                        <div class="review-box">
                            <ul>
                                <li><i class="fa fa-star"></i></li>
                    ...
                    <div class="text-box">
                        <p>All of the employees at Horizoncave are extremely helpful and friendly,
            ...
            <div class="col-xl-6 col-lg-6">
                <div class="single-testimonial-style2">
                    ...
                    <div class="text-box">
                        <p>My experience with transitioning has been great. Everyone at the
                            bank has been extremely accommodating. They make me feel that
                            my business matters. I like that the bank still feels like a small town
                            bank even though we are in quite a large community.</p>
                    </div>
                    <div class="customer-info">
                        <div class="img-box">
            ...
            <div class="col-xl-6 col-lg-6">
                <div class="single-testimonial-style2 bg-white">
                    ...
                    <div class="text-box">
                        <p>Horizoncave has been outstanding in the services they have provided me. I have utilized
                            ...
                            everything is done right the first time. Thanks :)</p>
                    </div>
                    <div class="customer-info">
                        <div class="img-box">
            ...
            <div class="col-xl-6 col-lg-6">
                <div class="single-testimonial-style2 bg-white">
                    ...
                    <div class="text-box">
                        <p>My experience with transitioning has been great.</p>
                    </div>
                    <div class="customer-info">
                        <div class="img-box">
                            <img src="assets/images/testimonial/testimonial-v1-4.jpg" alt="">
